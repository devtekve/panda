...
class Panda:
  ...
  HEALTH_STRUCT = struct.Struct("<IIIIIIIIIBBBBBBBHBBBHfBBHBHH")
  ...
  def health(self):
    ...
    return {
      ...
      "spi_checksum_error_count": a[24],
      "fan_stall_count": a[25],
      "sbu1_voltage_mV": a[26],
      "sbu2_voltage_mV": a[27],
    }
